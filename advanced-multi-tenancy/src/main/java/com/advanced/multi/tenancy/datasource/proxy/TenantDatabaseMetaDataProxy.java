 ...
 * @since 2023/7/16
 */
public class TenantDatabaseMetaDataProxy implements DatabaseMetaData {
    private final String dsKey;
    private final String tenantId;
    private final String schema;
    private final DatabaseMetaData delegate;

    public TenantDatabaseMetaDataProxy(DatabaseMetaData delegate, String dsKey, String tenantId, String schema) {
